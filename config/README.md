...
- These are the minimum required vars need to setup to make Rock Music Bot functional.
...
- You can play tracks or playlists from spotify from Rock Music bot
...
- If you plan to use Rock Music Bot with your own customized or modified code.
...
- You can change images which are used in Rock Music Bot.
- 
