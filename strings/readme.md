...
You can edit [`en.yml`](https://github.com/Rock-Muzic-V2/public/blob/xmarty/strings/langs/en.yml) present in langs folder to your own language and send us the edited file at [@rockSupport](https://t.me/Rockerz_Support)
